define(function () {
    ...
    var html =
        ...
        '        </div>' +
        '        <student-score-info content-data="ca" question-data="questionData" show-score-comment="false" show-sample-answer="true" show-student-answer="true"></student-score-info>' +
        '    </div>' +
        '</div>';
    return html;
});