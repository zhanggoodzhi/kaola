define(function () {
    ...
    var html =
        ...
        '        </div>' +
        '    </div>' +
        '    <div class="question-prompt" ng-if="questionData.Prompt!=undefined && questionData.Prompt.length>0">' +
        '        {{questionData.Prompt}}' +
        '    </div>' +
        ...
        '    </div>' +
        '    <div style="clear:both;"></div>' +
        '    <div class="question-tips" ng-if="questionData.Tips!=undefined && questionData.Tips.length>0">' +
        '        {{questionData.Tips}}' +
        '    </div>' +
        '    <div style="clear:both;"></div>' +
