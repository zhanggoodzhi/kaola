define(function () {
    ...
    var html =
        ...
        '    <div>' +
        '        <div style="float:left;font-size:15px;color:#444;max-width:600px;margin:16px 0px" ng-if="questionData.Text!=undefined && questionData.Text.length>0" ng-bind-html="questionData.Text|trustHtml">' +
        '        </div>' +
        '        <div style="float:left;font-size:15px;color:#444;max-width:600px;margin:16px 0px" ng-if="(questionData.Text == undefined|| questionData.Text.length<=0)&&(questionData.Prompt != undefined|| questionData.Prompt.length>0)" ng-bind-html="questionData.Prompt|trustHtml">' +
        '        </div>' +
