    ...
    function initialize($window, $log) {
        ...
        Deckgrid.prototype.$$createColumns = function $$createColumns() {
            ...
            if (!this.$$scope.layout) {
                return console.log('angular-deckgrid: No CSS configuration found');
            }
        ...
        Deckgrid.prototype.$$getLayout = function $$getLayout() {
            ...
            // hack by bianyunjian ,manually calculate column count
            if (content == null || content == undefined || content == "") {
                content = "classDeckGrid 300";
            }
            console.log("getComputedStyle content:", content);
            ...
            if (content != undefined && content != '') {
                ...
                if (cArray != null && cArray.length > 0) {
                    ...
                    var parentContainerID = cArray[0];
                    var cardFixedWidth = parseInt(cArray[1]);

                    var parentContainerWidth = $('#' + parentContainerID).width();
                    //console.log("parentContainerWidth:", parentContainerWidth);
                    //console.log("cardFixedWidth:", cardFixedWidth);
                    var n = (parentContainerWidth) / cardFixedWidth;

                    var cardNumber = Math.floor(n);


                    content = cardNumber + ' .column.size-1-' + cardNumber;

                    //console.log("get manual calculated content:", content);
                }
        ...
        Deckgrid.prototype.$$onMediaQueryChange = function $$onMediaQueryChange() {
            ...
            console.log("$$onMediaQueryChange");
            //
            // Okay, the layout has changed.
            // Creating a new column structure is not avoidable.
            //
            if (layout == undefined || layout.columns == undefined || this.$$scope.layout.columns == undefined) {
                return;
            }
