    ...
    angular.module('toaster', []).constant(
        ...
        'toaster', [
            '$rootScope', 'toasterConfig', function ($rootScope, toasterConfig) {
                ...
                this.trimBody = function (cstring) {
                ...
                this.pop = function (type, title, body, timeout, bodyOutputType, clickHandler, toasterId, showCloseButton, toastId, onHideCallback) {
                    if (angular.isObject(type)) {
                        ...
                        params.body = this.trimBody(params.body);
                        this.toast = {
                            type: params.type,
                            title: params.title,
                            body: params.body,
            ...
            function ($parse, $rootScope, $interval, $sce, toasterConfig, toaster, toasterEventRegistry) {
                return {
                    ...
                    link: function (scope, elm, attrs) {
                        ...
                        function findSameToast(toast) {
                            for (var i = 0; i < scope.toasters.length; i++) {
                                if (scope.toasters[i].type == toast.type && scope.toasters[i].body == toast.body) {
                                    //console.log('findSameToast');
                                    return true;
                                }
                            }
                            //console.log('not findSameToast');
                            return false;
                        }
                        ...
                        function addToast(toast, toastId) {
                            ...
                            if (findSameToast(toast)) return;// custom code, won't show the same toast
