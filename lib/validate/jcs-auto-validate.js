...
function Bootstrap3ElementModifierFn($log) {
  ...
  var reset = function (el) {
    ...
    findFormGroupElement = function (el) {
        var findEl = findWithClassElementAsc(el, 'form-group');
        if (findEl)
        {
            return findEl;
        }
        ...
        {
            return findInputGroupElement(el);
        }
    },
    ...
    makeInvalid = function (el, errorMsg) {
      var frmGroupEl = findFormGroupElement(el),
        helpTextEl = angular.element('<span class="help-block has-error error-msg"><img src="/web/img/validateErrorIcon.png" />' + errorMsg + '</span>'),
        inputGroupEl;
