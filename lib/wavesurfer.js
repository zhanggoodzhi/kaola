(function (root, factory) {
    ...
    var WaveSurfer = {
        ...
        drawBuffer: function () {
            ...
            var nominalWidth = Math.round(
               duration * this.params.minPxPerSec * this.params.pixelRatio
            );
            var parentWidth = this.drawer.getWidth();
            //console.log("wavesurfer parentWidth", parentWidth);
            var width = nominalWidth;
            //console.log("wavesurfer width", width);
            ...
            if (this.params.fillParent && (!this.params.scrollParent || nominalWidth < parentWidth)) {
                width = parentWidth;
                //console.log("wavesurfer width=parentWidth", width);
                start = 0;
                end = width;
            }
            if (this.params.partialRender) {
                ...
                //console.log("wavesurfer width, start, end", width, start, end);
        ...
        decodeArrayBuffer: function (arraybuffer, callback) {
            ...
            this.backend.decodeArrayBuffer(
                ...
                (function (data) {
                    ...
                    //console.log("wavesurfer backend decodeArrayBuffer finished", !this.isDestroyed && this.arraybuffer == arraybuffer);
    ...
    WaveSurfer.WebAudio = {
        ...
        getPeaks: function (length, first, last) {
            ...
            //console.log("wavesurfer recalc peaks", length, first, last);
        ...
        destroy: function () {
            ...
            if (!this.params.audioContext) {
                ...
                if (typeof this.ac.close() !== 'undefined') {
                    if (this.ac.state != 'undefined' && this.ac.state != 'closed') {
                        this.ac.close();
                    }
                }
            }
    ...
    WaveSurfer.Drawer = {
        ...
        getWidth: function () {
            ...
            if (clientWidth <= 0 && this.params.minWaveformWidth) {
                clientWidth = this.params.minWaveformWidth;
                console.log("wavesurfer drawer minWaveformWidth", clientWidth);
            }           
            return Math.round(clientWidth * this.params.pixelRatio);
        },
