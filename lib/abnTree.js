          ...
          return {
              ...
              link: function (scope, element, attrs) {
                  ...
                  if (attrs.iconExpand == null) {
                      attrs.iconExpand = 'smallicon icon-liebiao icon-2em';
                  }
                  if (attrs.iconCollapse == null) {
                      attrs.iconCollapse = 'smallicon icon-chengjifabu icon-2em';
                  }
                  if (attrs.iconLeaf == null) {
                      attrs.iconLeaf = 'smallicon icon-yuangongyeji icon-2em';
                  }
                  ...
                  //console.log('number of root branches = ' + n);
                  for_each_branch(function (b, level) {
                      b.level = level;
